            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              ...
              <div style={{ background: '#1A1F28', border: '0.5px solid rgba(200,194,187,0.09)', borderRadius: 7, overflow: 'hidden' }}>
                ...
                <div style={{ padding: 18, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                  ...
                  {project.category !== 'Property' && (
                    <div style={{ gridColumn: 'span 2' }}><label style={lbl}>Shoot location</label><input style={inp} value={project.address} onChange={e => updateField('address', e.target.value)} /></div>
                  )}
                </div>
              </div>
          ...
          {activeTab === 'editor' && (
            <div style={{ background: '#1A1F28', border: '0.5px solid rgba(200,194,187,0.09)', borderRadius: 7, overflow: 'hidden' }}>
              ...
              <div style={{ padding: 18 }}>
                ...
                <textarea value={project.editor_notes} onChange={e => updateField('editor_notes', e.target.value)} style={{ ...inp, resize: 'vertical' as const, lineHeight: 1.75, minHeight: 380, fontSize: 13 }} placeholder="e.g. Grade — warm, filmic. Music — cinematic, no lyrics. Feature kitchen prominently..." />
              </div>
            </div>
          )}
